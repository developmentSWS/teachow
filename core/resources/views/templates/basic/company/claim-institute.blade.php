                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    <div class="m-b-25">
                                        <img src="{{ getImage(imagePath()['company']['path'] . '/' . $company->image) }}" class="img-radius"
                            ...
                            <div class="col-sm-8">
                                <form method="post" action="{{ route('user.saveInstituteClaimFrom', ['id' => $company->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Claim This Institute Profile</h6>
                                        <p class="text-center">
                                                 <!--Kindly upload any govt issued document to claim account-->
                                                 Your document shall be used solely for the purpose of authentication of your claim of account and the uploaded document shall be auto-deleted after a period of 1 month.
                                        </p>
                                           <p class="text-center" style="font-size: 11px; color:black;"> Udyog Aadhaar  / Registration document / Pan Card of organisation or proprietor
                                            </p>
