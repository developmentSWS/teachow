    ...
    <div class="col-lg-6">
        <div class="company-review has--link">
            ...
            <div class="company-review__top">
                <div class="thumb">
                    <img src="{{ getImage(imagePath()['company']['path'] . '/' . @$company->image) }}" alt="company logo">
...
@empty
    ...
    <div class="action-widget bg--base mt-4 text-center rounded-3 p-4">
        <h4 class="text-white">{{ __('Looking for your Instittue') }}</h4>
            <a href="{{ route('user.company.create') }}" class="btn bg-white mt-4">{{ __('Add Now') }}</a>
    </div>
@endforelse
<div class="mt-3">
