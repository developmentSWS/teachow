                        ...
                        <div class="contact-wrapper d-flex flex-wrap">
                            <div class="contact-wrapper__left">
                                <div class="contact-content-header">
                                    ...
                                    <div class="content">
                                        <p>@lang('OTP Send To Your Email For Verification'):
                                           
                                        </p>
                                    </div>
                                </div>
                                <form class="contact-form" action="{{ route('user.verify.otp') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="custom-icon-field">
                                                ...
                                                <input type="text" name="sms_verified_code" id="code" autocomplete="off" class="form--control" placeholder="@lang('Enter valid code')" required>
                                            </div>
                                        </div>
                                       

                                        <div class="col-lg-12">
                                            <button type="submit" class="btn btn--base w-100"><i class="lab la-telegram-plane"></i> @lang('Verify')</button>
                                        </div>

                                        <div class="form-group mt-2">
                                            <p>
                                                @lang('If you don\'t get any code'), <a href="#" class="forget-pass"> @lang('Try again')</a></p>
