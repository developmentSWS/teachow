    ...
    <section class="pt-50 pb-50 contact-section overflow-hidden">
        ...
        <div class="container">
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8">
                    <form class="create-company-form" action="{{ route('user.teacher.store') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="custom--card">

                            <div class="card-header bg--dark">
                                <h5 class="text-white">@lang('Provide Your Teacher Information')</h5>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category[]" class="form--control institute" multiple>
                                                <option value="kk" >@lang('Other')</option>
                                                <option value="mm" >@lang('Free Lancer')</option>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input type="text" name="subject" class="form--control" value="{{ old('address') }}" required>
                                    </div>

                                    <div class="col-lg-12 form-group">
                                        <label>@lang('Experience') </label>
                                        <textarea name="experience" class="form--control" >{{ old('description') }}</textarea>
                                    </div>
                                </div><!-- row end -->
