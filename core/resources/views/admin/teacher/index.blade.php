                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Name')</th>
                                    <th>@lang('Email')</th>
                                    @if(request()->routeIs('admin.teacher.index'))
                                    <th>@lang('Status')</th>
                                    @endif
                                    <th>@lang('Action')</th>
                                </tr>
                                ...
                                @forelse ($companies as $company)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.teacher.details', $company->id) }}" class="icon-btn ml-1" data-toggle="tooltip" data-original-title="@lang('Detail')">
